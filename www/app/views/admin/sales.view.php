...
<div>
		<form class="row float-end" method="get">
			...
			<div class="col">
				...
				<input style="max-width: 80px;" class="form-control" id="limit" type="number" min="1" name="limit" value="<?=!empty($_GET['limit']) ? $_GET['limit']:'10'?>">
			</div>
			
			<button style="max-width: 50px;" class="btn btn-sm btn-primary col">Go <i class="fa fa-chevron-right"></i> </button>
...
<div class="table-responsive">
	...
	<h2>Totay's Total : Rs. <?=number_format($sales_total,2)?></h2>
